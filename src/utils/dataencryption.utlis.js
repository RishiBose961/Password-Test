...
const algorithm = 'aes-256-gcm'; //Advanced Encryption Standard with a 256-bit key in Galois/Counter Mode
...
function encrypt(text) {
    ...
    console.log("Cipher:", Buffer.from(secretKey, 'hex'));
    ...
    console.table({
        algorithm,
        secretKey: Buffer.from(secretKey, 'hex').toString('hex'),
        iv: iv.toString('hex'),
        encrypted,
        authTag
    });
